...
export default function Carousel({images}) {
    ...
    return (
      <div className="carousel">
        ...
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3 mt-3 skills--section--heading">My Projects</h3>
            </div>
            <div class="col-6 text-right">
                <a class="btn btn-primary mb-3 mr-1 mt-3" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <a class="btn btn-primary mb-3 mt-3" href="#carouselExampleIndicators2" role="button" data-slide="next">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="./img/image2.png"/>
                                        <div class="card-body ">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card">
                                        <img class="img-fluid size" alt="100%x280" src="./img/image3.png"/>
                                        <div class="card-body">
